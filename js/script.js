...
const generateResponse = (chatElement) => {
    ...
    fetch(API_URL, requestOptions).then(res => res.json()).then(data => {
        ...
        messageElement.textContent = "我現在還沒有作用 |"+" Oops! I dont know how to reply this answer. Please try again.";
...
const handleChat = () => {
    ...
    setTimeout(() => {
        ...
        const incomingChatLi = createChatLi("我想一想 | Thinking...", "incoming");
